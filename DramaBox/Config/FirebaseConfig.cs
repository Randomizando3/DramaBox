...
public static class FirebaseConfig
{
    ...
    // Storage bucket (como você informou)
    ...
    // Ex: https://dramabox-93e83-default-rtdb.firebaseio.com
    public static string RealtimeBaseUrl { get; set; } = "https://dramabox-93e83-default-rtdb.firebaseio.com";

    // Se você estiver usando regras abertas para "official" pode deixar vazio.
    // Se quiser usar secret/token no futuro, coloque aqui.
